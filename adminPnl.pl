...
sleep (1);
    print "\n\n";
    print "\t Site Adı=> (Örnek: http://www.site.com)\n";
    print "\t Site Adı=> :";
    $host=<STDIN>;
    chomp($host);
...
if ($response->is_success){print "Buldu : $url\n";}
if ($response->content=~ /Access Denied/){print "Buldu : $url =>[Hata & Erişim reddedildi]\n";}
else {print "Bulamadı : $myadmin\n";}
